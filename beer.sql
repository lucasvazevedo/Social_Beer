...
VALUES ('Guinness', 'Ale', 'Guinness Draft', '4,2%', 45);
 
INSERT INTO Beer (fabricante, familia, nome, graduacao, ibu)
VALUES ('Heineken', 'Lager', 'Heineken', '5%', 19);
 
INSERT INTO Beer (fabricante, familia, nome, graduacao, ibu)
VALUES ('BrewDog', 'Ale', 'Punk IPA', '5,6%', 35);
 
INSERT INTO Beer (fabricante, familia, nome, graduacao, ibu)
VALUES ('Grupo Modelo', 'Lager', 'Corona Extra', '4,5%', 18);
 
INSERT INTO Beer (fabricante, familia, nome, graduacao, ibu)
VALUES ('Anheuser-Busch InBev', 'Lager', 'Budweiser', '5%', 12);
 
INSERT INTO Beer (fabricante, familia, nome, graduacao, ibu)
VALUES ('Carlsberg Group', 'Lager', 'Carlsberg', '5%', 28);
 
INSERT INTO Beer (fabricante, familia, nome, graduacao, ibu)
VALUES ('Asahi Group Holdings', 'Lager', 'Asahi Super Dry', '5%', 24);
 
INSERT INTO Beer (fabricante, familia, nome, graduacao, ibu)
VALUES ('Molson Coors', 'Lager', 'Coors Light', '4,2%', 10);
 
INSERT INTO Beer (fabricante, familia, nome, graduacao, ibu)
VALUES ('SABMiller', 'Lager', 'Miller Lite', '4,2%', 10);
